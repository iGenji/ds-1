...
public class TestVecteurDeCaracteresImpl {
	...
	private static void testInsere() {
		...
		try{
			vABC5.insere(1, 'x');
			assertEquals("KO : vecteur : a b c - insere(1,'x') : contenu ko", "a x b c", vABC5.toString());
			assertEquals("KO : vecteur : a b c - insere(1,'x') : taille ko", 4, vABC5.taille());
			
		}catch (VecteurOutException e){
			System.out.println("KO : vecteur : a b c - insere(1,'x') : Il ne fallait pas de VecteurOutException");
			System.exit(0);
		}catch (Exception e) {
			System.out.println("KO : vecteur : a b c - insere(1,'x') : il y a eu une exception non prevue");
			e.printStackTrace();
			System.exit(0);
		}
		...
		try{
			vABC5.insere(2, 'x');
			assertEquals("KO : vecteur : a b c - insere(2,'x') : contenu ko", "a b x c", vABC5.toString());
			assertEquals("KO : vecteur : a b c - insere(2,'x') : taille ko", 4, vABC5.taille());
			
		}catch (VecteurOutException e){
			System.out.println("KO : vecteur : a b c - insere(2,'x') : Il ne fallait pas de VecteurOutException");
			System.exit(0);
		}catch (Exception e) {
			System.out.println("KO : vecteur : a b c - insere(2,'x') : il y a eu une exception non prevue");
			e.printStackTrace();
			System.exit(0);
		}
		...
		try{
			vABC5.insere(0, 'x');
			assertEquals("KO : vecteur : a b c - insere(0,'x') : contenu ko", "x a b c", vABC5.toString());
			assertEquals("KO : vecteur : a b c - insere(0,'x') : taille ko", 4, vABC5.taille());
			
		}catch (VecteurOutException e){
			System.out.println("KO : vecteur : a b c - insere(0,'x') : Il ne fallait pas de VecteurOutException");
			System.exit(0);
		}catch (Exception e) {
			System.out.println("KO : vecteur : a b c - insere(0,'x') : il y a eu une exception non prevue");
			e.printStackTrace();
			System.exit(0);
		}
		...
		try{
			vABC5.insere(3, 'x');
			assertEquals("KO : vecteur : a b c - insere(3,'x') : contenu ko", "a b c x", vABC5.toString());
			assertEquals("KO : vecteur : a b c - insere(3,'x') : taille ko", 4, vABC5.taille());
			
		}catch (VecteurOutException e){
			System.out.println("KO : vecteur : a b c - insere(3,'x') : Il ne fallait pas de VecteurOutException");
			System.exit(0);
		}catch (Exception e) {
			System.out.println("KO : vecteur : a b c - insere(3,'x') : il y a eu une exception non prevue");
			e.printStackTrace();
			System.exit(0);
		}
	...
	private static void testSupprime() {
		...
		vABC5=new VecteurDeCaracteresImpl(5,tABC);
		try{
			assertEquals("KO : vecteur : a b c - supprime(1) : caractere renvoye", 'b',vABC5.supprime(1));
			assertEquals("KO : vecteur : a b c - supprime(1) : contenu ko", "a c", vABC5.toString());
			assertEquals("KO : vecteur : a b c - supprime(1) : taille ko", 2, vABC5.taille());
			
		}catch (VecteurOutException e){
			System.out.println("KO : vecteur : a b c - supprime(1) : Il ne fallait pas de VecteurOutException");
			System.exit(0);
		}catch (Exception e) {
			System.out.println("KO : vecteur : a b c - supprime(1) : il y a eu une exception non prevue");
			e.printStackTrace();
			System.exit(0);
		}
		...
		vABC5=new VecteurDeCaracteresImpl(5,tABC);
		try{
			assertEquals("KO : vecteur : a b c - supprime(0) : caractere renvoye", 'a',vABC5.supprime(0));
			assertEquals("KO : vecteur : a b c - supprime(0) : contenu ko", "b c", vABC5.toString());
			assertEquals("KO : vecteur : a b c - supprime(0) : taille ko", 2, vABC5.taille());
			
		}catch (VecteurOutException e){
			System.out.println("KO : vecteur : a b c - supprime(0) : Il ne fallait pas de VecteurOutException");
			System.exit(0);
		}catch (Exception e) {
			System.out.println("KO : vecteur : a b c - supprime(0) : il y a eu une exception non prevue");
			e.printStackTrace();
			System.exit(0);
		}
		...
		vABC5=new VecteurDeCaracteresImpl(5,tABC);
		try{
			assertEquals("KO : vecteur : a b c - supprime(2) : caractere renvoye", 'c',vABC5.supprime(2));
			assertEquals("KO : vecteur : a b c - supprime(2) : contenu ko", "a b", vABC5.toString());
			assertEquals("KO : vecteur : a b c - supprime(2) : taille ko", 2, vABC5.taille());
			
		}catch (VecteurOutException e){
			System.out.println("KO : vecteur : a b c - supprime(2) : Il ne fallait pas de VecteurOutException");
			System.exit(0);
		}catch (Exception e) {
			System.out.println("KO : vecteur : a b c - supprime(2) : il y a eu une exception non prevue");
			e.printStackTrace();
			System.exit(0);
		}
