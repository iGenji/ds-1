...
public class TestPileDeCaracteresViaTable{
	
	static Class classe = PileDeCaracteresViaTable.class;
	static Field t ;
	
	public static void main(String[] args) throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
		
		System.out.println("******************************************************");
		System.out.println("Programme Test pour la classe PileDeCaracteresViaTable");
		System.out.println("******************************************************");
		
		System.out.println("\nLes tests correspondent aux tests de l'exercice B1");
		...
		char c;
		char[] table;
		PileDeCaracteresViaTable pile = new PileDeCaracteresViaTable();
